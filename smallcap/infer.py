...
if __name__ == '__main__':
    ...
    parser.add_argument("--features_path", type=str, default='fine-tuning/features/val.hdf5', help="H5 file with cached input image features")
    parser.add_argument("--annotations_path", type=str, default="fine-tuning/datastore/index2.json", help="JSON file with annotations in Karpathy splits")
    ...
    parser.add_argument("--captions_path", type=str, default="fine-tuning/data/retrieved_caps_resnet50x64.json", help="JSON file with retrieved captions")
